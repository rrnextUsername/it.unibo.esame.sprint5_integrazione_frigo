		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t013",targetState="handleMsgFridge",cond=whenEvent("msgFridge"))
					transition(edgeName="t014",targetState="exposeFood",cond=whenEvent("exposeFood"))
				}	 
